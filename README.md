...
Double-click `index.html`. It opens in your default browser. Good enough for quick checks.
...
1. Create a new GitHub repository (e.g. `mara-voss-portfolio`) and push this folder to it:
   ```bash
   git init
   git add .
